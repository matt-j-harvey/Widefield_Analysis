...
def regress_activity_onto_whole_video(base_directory, early_cutoff=3000):
    ...
    print("Train Mousecam Frames", train_mousecam_frames)

    #train_x = bodycam_motion_data[train_mousecam_frames]
    #test_x = bodycam_motion_data[test_mousecam_frames]
    train_x = get_bodycam_sample(bodycam_motion_data, train_mousecam_frames)
    test_x = get_bodycam_sample(bodycam_motion_data, test_mousecam_frames)
