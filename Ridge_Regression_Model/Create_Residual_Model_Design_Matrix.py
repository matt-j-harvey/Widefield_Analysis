...
def create_residual_model_design_matrix(base_directory, data_root_directory, tensor_root_directory, start_window, stop_window, onset_files, start_cutoff=3000):
