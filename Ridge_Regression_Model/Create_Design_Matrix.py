...
def create_design_matrix(base_directory):
    ...
    design_matrix = stats.zscore(design_matrix, axis=0)
    ...
    np.save(os.path.join(save_directory, "Design_Matrix.npy"), design_matrix)
    np.save(os.path.join(save_directory, "design_matrix_key_dict.npy"), design_matrix_key_dict)
