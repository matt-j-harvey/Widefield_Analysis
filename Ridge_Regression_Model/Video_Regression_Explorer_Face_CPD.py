...
class coef_viewer(QWidget):
    ...
    def change_pixel(self, pos, imageview):
        ...
        self.coef_display_view.setLevels(min=-10, max=10)
        #self.coef_display_view.histogram.setLevels(min=-0.1, max=1)
...
if __name__ == '__main__':
    ...
    print("Coef high", np.percentile(components, q=99))
    print("Coef low", np.percentile(components, q=1))
