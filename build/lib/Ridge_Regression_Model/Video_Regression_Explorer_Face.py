...
class coef_viewer(QWidget):
    ...
    def __init__(self, r2_map, regression_coefs, parent=None):
        ...
        cmap = pyqtgraph.colormap.getFromMatplotlib('bwr')
    ...
    def change_pixel(self, pos, imageview):
        ...
        #self.coef_display_view.setLevels((-0.001, 0.001))
        self.coef_display_view.setImage(np.abs(regression_map))
        print("Coef Magnitude", coef_magnitude)
...
if __name__ == '__main__':
    ...
    regression_coefs = reconstruct_coefs(regression_coefs, face_pixels)
    print("Regression coefs", np.shape(regression_coefs))
    # Reconstrcut R2 Map
