...
class roi_selection_window(QWidget):
    ...
    def __init__(self, session_list, image_list, index_map, parent=None):
        ...
        self.brain_display_view.setImage(self.image_list[0])
    ...
    def map_region(self):
        ...
        print("Left ROI Indicies", np.shape(left_roi_indicies))
        ...
        for session in self.session_list:
            print("Saving at ", os.path.join(session, "Selected_ROI.npy"))
...
if __name__ == '__main__':
    ...
    aligned_images_list = load_brain_images(selected_session_list)

    selection_window = roi_selection_window(selected_session_list, aligned_images_list, index_map)
