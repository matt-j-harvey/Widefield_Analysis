...
def preprocess_session(session_directory):
    ...
    # Load Delta F Data
    corrected_svt = np.load(os.path.join(session_directory, "Churchland_Preprocessing_Experimental", "Corrected_SVT.npy"))
    ...
    for chunk_index in range(number_of_chunks):
        ...
        delta_f_chunk = np.dot(u[:, :, 0:200], delta_f_chunk)
    ...
    # Save This
    np.save(os.path.join(session_directory, "Delta_F_Matrix_100_by_100_SVD_200.npy"), delta_f_matrix)
    """
...
session_list = ["/media/matthew/Expansion/Control_Data/NXAK4.1B/2021_03_02_Switching_Imaging"]
