...
controls = [   "/media/matthew/Seagate Expansion Drive1/Switching_Analysis/Wildtype/NXAK14.1A/2021_06_09_Switching_Imaging"]
for base_directory in controls:
    downsample_running_trace(base_directory, sanity_check=False
