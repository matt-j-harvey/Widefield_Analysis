...
def analyse_signal_correlations(base_directory, onset_files, tensor_names, start_window, stop_window, tensor_save_directory, tensor_cutoff):
...
print("Tensor cutoff", tensor_cutoff)
for base_directory in session_list:
    print("Analysing Session: ", base_directory)
    analyse_signal_correlations(base_directory, onset_files, tensor_names, start_window, stop_window, tensor_save_directory, tensor_cutoff)
