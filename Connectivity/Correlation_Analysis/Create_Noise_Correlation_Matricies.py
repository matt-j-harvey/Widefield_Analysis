...
for base_directory in tqdm(session_list):
    ...
    #analyse_noise_correlations(base_directory, onset_files, tensor_names, start_window, stop_window, tensor_save_directory, aligned="Within_Mouse")
    analyse_noise_correlations(base_directory, onset_files, tensor_names, start_window, stop_window, tensor_save_directory, aligned="Across_Mice")
