...
def get_group_averages(control_session_list, mutant_session_list, condition_list, start_window, stop_window, selected_region, min_trials=5):
    ...
    for condition_index in range(number_of_conditions):
        ...
        alpha_value = 0.3
        for mouse in control_lick_traces:
            lick_axis.plot(x_values, mouse, c='b', alpha=alpha_value)

        for mouse in mutant_lick_traces:
            lick_axis.plot(x_values, mouse, c='g', alpha=alpha_value)
...
get_group_averages(control_session_list, mutant_session_list, condition_list, start_window, stop_window, selected_region=24, min_trials=5)
"""

condition_1 = "visual_2_correct_onsets.npy"
condition_2 = "visual_2_incorrect_onsets.npy"
condition_list = [condition_1, condition_2]
get_group_averages(control_session_list_post, mutant_session_list_post, condition_list, start_window, stop_window, selected_region=25, min_trials=5)