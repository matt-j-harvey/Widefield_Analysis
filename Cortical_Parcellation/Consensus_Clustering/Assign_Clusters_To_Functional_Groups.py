...
class curation_window(QWidget):
    ...
    def __init__(self, pixel_assignments, parent=None):
        ...
        self.cluster_list_widget.currentRowChanged.connect(self.update_selected_clusters)

        # Create Group Assignment List
        self.cluster_group_assignments = list(np.zeros(self.num))
    ...
    def update_selected_clusters(self):
        ...
        if self.cluster_list_widget.currentItem() != None:
