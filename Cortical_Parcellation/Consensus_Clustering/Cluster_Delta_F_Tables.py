...
def cluster_delta_f(base_directory):
    ...
    data_matrix = delta_f_file.root.Data
...
session_list = [
    ...
    #r"/media/matthew/Expansion/Widefield_Analysis/NXAK7.1B/2021_02_24_Discrimination_Imaging", - do this later
