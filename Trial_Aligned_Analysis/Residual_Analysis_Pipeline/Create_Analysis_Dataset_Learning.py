        ...
        for mouse in group:
            ...
            for learning_stage in mouse:
                ...
                for session in learning_stage:
                    ...
                    print("Session", session, "Learning Stage", learning_index, "Condition", condition, "Activity Tensor", np.shape(activity_tensor))

                    # Add Data To Dataset
                    for trial in activity_tensor:
                        activity_dataset.append([trial])
                        metadata_dataset.append([np.array([group_index, mouse_index, session_index, learning_index])])
