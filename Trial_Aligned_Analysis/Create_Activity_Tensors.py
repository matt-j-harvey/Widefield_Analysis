...
def create_activity_tensor(base_directory, onsets_file, start_window, stop_window, tensor_save_directory, ridge_regression_correct,
                           start_cutoff=3000,
    ...
    if align_across_mice == True:
        activity_tensor_name = tensor_name + "_Residual_Tensor_Aligned_Across_Mice.npy"

    elif align_within_mice == True:
        activity_tensor_name = tensor_name + "_Residual_Tensor_Aligned_Within_Mouse.npy"

    else:
        activity_tensor_name = tensor_name + "_Residual_Tensor_Unaligned.npy"
...
tensor_save_directory = r"/media/matthew/External_Harddrive_2/Neurexin_Transition_Tensors"
...
for base_directory in tqdm(selected_session_list):
    for onsets_file in onset_files:
        create_activity_tensor(base_directory, onsets_file, start_window, stop_window, tensor_save_directory, ridge_regression_correct,
                           start_cutoff=3000,
                           align_within_mice=True,
                           align_across_mice=True,
                           baseline_correct=False,
