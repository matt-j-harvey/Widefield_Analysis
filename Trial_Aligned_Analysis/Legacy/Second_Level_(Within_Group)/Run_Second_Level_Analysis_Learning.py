...
control_pre_learning_session_list = Session_List.control_pre_learning_session_list
control_post_learning_session_list = Session_List.control_post_learning_session_list

# Get Difference Tensor
pre_learning_tensor = get_mean_session_tensor_reconstructed(control_pre_learning_session_list, onset_files, tensor_save_directory)
post_learning_tensor = get_mean_session_tensor_reconstructed(control_post_learning_session_list, onset_files, tensor_save_directory)

# Save This
np.save(os.path.join(signficance_testing_folder, "Controls_Pre_Learning_Session_Average.npy"), mean_session_tensor)
