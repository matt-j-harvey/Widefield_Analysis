...
def add_mouse_data_to_dataframe(mouse_sesssions, mouse_index, data_container, trial_detail_container, tensor_save_directory, condition_name):
...
def create_intermediate_dataset(nested_session_list, tensor_save_directory, intermediate_file_location, condition_name, trial_length, number_of_pixels, group_names):
    ...
    for mouse in tqdm(nested_session_list):
        add_mouse_data_to_dataframe(mouse[0], mouse_index, group_1_data_container, group_1_trial_detail_container, tensor_save_directory, condition_name)
        add_mouse_data_to_dataframe(mouse[1], mouse_index, group_2_data_container, group_2_trial_detail_container, tensor_save_directory, condition_name)
        mouse_index += 1
...
def paired_sessions_mixed_effects(nested_session_list, tensor_save_directory, condition_file, intermediate_file_location, analysis_name, group_names):
    ...
    create_intermediate_dataset(nested_session_list, tensor_save_directory, intermediate_file_location, condition_name, trial_length, number_of_pixels, group_names)
...
### Controls Learning ###
significance_testing_folder = r"/media/matthew/29D46574463D2856/Significance_Testing/Control_Learning"

# Load Session List
control_learning_tuples = Session_List.control_session_tuples

# Perform Mixed Effects Modelling
paired_sessions_mixed_effects(control_learning_tuples, tensor_save_directory, onset_files[0], significance_testing_folder, analysis_name, group_names)



### Mutants Learning ###
significance_testing_folder = r"/media/matthew/29D46574463D2856/Significance_Testing/Mutant_Learning"

# Load Session List
mutant_learning_tuples = Session_List.mutant_session_tuples

# Perform Mixed Effects Modelling
paired_sessions_mixed_effects(mutant_learning_tuples, tensor_save_directory, onset_files[0], significance_testing_folder, analysis_name, group_names)
