...
def run_raw_pipeline(selected_session_list, analysis_name, data_root_diretory, tensor_save_directory, start_cutoff=3000):
    ...
    Visualise_Average_Activity.view_average_difference(tensor_save_directory, condition_1_index, condition_2_index, comparison_name, vmin=-0.02, vmax=0.02)
...
tensor_save_directory = r"/media/matthew/External_Harddrive_2/Raw_Pipeline_Results/Neurexin_Learning_Vis_1_Full_Prestim"
...
run_raw_pipeline(selected_session_list, analysis_name, data_root_directory, tensor_save_directory)