...
def repackage_data_into_dataframe(activity_list, mouse_list, condition_list, session_list):
...
def prepare_data_for_dataframe(condition_1_mouse_average_list, condition_2_mouse_average_list):
    ...
    for mouse_index in range(number_of_mice):
        ...
        for session_index in range(number_of_sessions):
            ...
            session_list.append(session_counter)
    ...
    return activity_list, mouse_list, condition_list, session_list
...
def test_significance_window(tensor_directory, analysis_name, condition_1, condition_2, baseline_window, response_window):
    ...
    # Prepare For DF
    activity_list, mouse_list, condition_list, session_list = prepare_data_for_dataframe(condition_1_mouse_average_list, condition_2_mouse_average_list)
    ...
    for pixel_index in tqdm(range(number_of_pixels), position=1, desc="Pixel", leave=False):
        ...
        pixel_dataframe = repackage_data_into_dataframe(pixel_activity, mouse_list, condition_list, session_list)
...
def test_significance_window_learning(tensor_directory, analysis_name, baseline_window, response_window):
    ...
    # Get Mouse Condition Averages
    condition_1_mouse_average_list, condition_2_mouse_average_list = get_mo(activity_dataset, metadata_dataset, condition_1, condition_2, baseline_window, response_window)
