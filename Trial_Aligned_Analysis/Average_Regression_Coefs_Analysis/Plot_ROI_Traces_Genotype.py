...
def quantify_roi_activity_across_genotypes(tensor_directory, roi_list, roi_name, condition_index, start_window, stop_window):
    ...
    condition_1_data = condition_averages[0, :, condition_index]
    condition_2_data = condition_averages[1, :, condition_index]
    print("Condition 1 Data", np.shape(condition_1_data))
...
tensor_directory = r"/media/matthew/External_Harddrive_2/Full_Pipeline_Results/Genotype_Comparison_Switching"
...
roi_name = "M2"
condition_index = 1
quantify_roi_activity_across_genotypes(tensor_directory, roi_list, roi_name, condition_index, start_window, stop_window)
