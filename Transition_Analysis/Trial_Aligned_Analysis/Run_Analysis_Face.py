...
import Create_Extended_Tensors_Face
...
def create_activity_tensors(session_list, onset_file_list, tensor_name_list, start_window, stop_stimuli_list, selected_behaviour_traces, tensor_save_directory):
    ...
    for base_directory in session_list:
        for condition_index in range(number_of_conditions):
            ...
            Create_Extended_Tensors_Face.create_extended_standard_alignment_tensor(base_directory, tensor_save_directory, condition_onset_file, start_window, stop_stimuli, selected_behaviour_traces, min_trial_number=1, max_trial_num=500, movement_correction=True)
