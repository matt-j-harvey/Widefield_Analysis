...
def visualise_tensor(base_directory, activity_tensor):
    ...
    print("Tensor Shape", np.shape(activity_tensor))
...
def create_activity_tensor(base_directory, onsets_file, trial_start, trial_stop, tensor_name, spatial_smoothing=False, smoothing_sd=2, save_tensor=True, visualise_tensor=False):
    ...
    if visualise_tensor == True:
        visualise_tensor(base_directory, activity_tensor)
