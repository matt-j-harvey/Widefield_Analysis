...
control_sessions = controls_pre_learning
mutant_sessions = neurexin_pre_learning

control_sessions = controls_post_learning
mutant_sessions = neurexin_post_learning
onsets_name = "Genotype_RT_Matched_Vis_1_Onsets_D_Prime"


control_sessions = neurexin_pre_learning
mutant_sessions = neurexin_post_learning
onsets_name = "Learning_RT_Matched"
