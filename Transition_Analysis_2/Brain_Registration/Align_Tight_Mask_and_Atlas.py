...
class masking_window(QWidget):
    ...
    def draw_images(self):
        ...
        if self.template_session_list_widget.currentItem().text() == "Mask":
            ...
            # Apply Mask
            print("Transformed Mask Shape", np.shape(transformed_mask))
    ...
    def transform_mask_or_atlas(self, image, variable_dictionary):
        ...
        # Copy
        transformed_image = np.copy(image)
        transformed_image = np.multiply(transformed_image, 255)
    ...
    def set_alignment(self):
        ...
        # Save Dictionaries
        np.save("Atlas_Alignment_Dictionary.npy", self.atlas_variable_dictionary)
        np.save("Tight_Mask_Alignment_Dictionary.npy", self.mask_variable_dictionary)
...
mask_location = "Tight_Mask.npy"
atlas_outline_location = "Atlas_Outlines.npy"
